...
var _bannerbearRoutes = _interopRequireDefault(require("./routes/bannerbear.routes.js"));
...
var _metaRoutes = _interopRequireDefault(require("./routes/meta.routes.js"));
var _canvaRoutes = _interopRequireDefault(require("./routes/canva.routes.js"));
var _s3bucketRoutes = _interopRequireDefault(require("./routes/s3bucket.routes.js"));
...
app.use('/api/banner', _bannerbearRoutes["default"]);
app.use('/api/canva', _canvaRoutes["default"]);
app.use('/api/news', _newsRoutes["default"]);
app.use('/api/prices', _pricesRoutes["default"]);
app.use('/api/twitter', _twitterRoutes["default"]);
app.use('/api/meta', _metaRoutes["default"]);
app.use('/api/s3', _s3bucketRoutes["default"]);
var symbol = 'BTC_USDT';
