...
var OutsourceArticle = require('../models/news.model');
function getNews() {
  return _getNews.apply(this, arguments);
}
function _getNews() {
  _getNews = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var apiKey, url, response, newsResponse, _iterator, _step, article, exists, _t, _t2;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          url = "https://newsdata.io/api/1/news?apikey=".concat(apiKey, "&q=crypto&language=en");
          _context.n = 2;
        ...
        case 2:
          ...
          _iterator = _createForOfIteratorHelper(newsResponse.results);
          _context.p = 3;
          _iterator.s();
        case 4:
        ...
        case 5:
          _context.n = 6;
          return OutsourceArticle.exists({
            title: article.title
          });
        case 6:
          exists = _context.v;
          ...
          _context.n = 7;
          return OutsourceArticle.create({
            title: article.title,
